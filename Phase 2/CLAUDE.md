...
For this Todo Full-Stack Web Application project, you will use the following specialized agents:

- **Auth Agent**: For authentication implementation using Better Auth
  - Implement user signup/signin functionality
...
- **Frontend Agent**: For frontend development using Next.js
  ...
  - Implement user interfaces for task management
  - Handle state management and client-side interactions

- **DB Agent**: For database design and operations using Neon Serverless PostgreSQL
...
- **Backend Agent**: For FastAPI development
  ...
  - Handle authentication middleware and authorization
